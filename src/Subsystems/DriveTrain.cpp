...
//Wheel speed directions will be inverted if it is closer to turn the wheel 180 deg off from actual setpoint
	...
	if(driveFront) {
		...
		if(fabs(FLSetPoint + FLOffset - frontLeftPos->GetDistance()) < 1.25 || fabs(FLSetPoint + FLOffset - frontLeftPos->GetDistance()) > 3.75)
		{
		...
		if(fabs(FRSetPoint + FROffset - frontRightPos->GetDistance()) < 1.25 || fabs(FRSetPoint + FROffset - frontRightPos->GetDistance()) > 3.75)
		{
		...
		if(fabs(RLSetPoint + RLOffset - rearLeftPos->GetDistance()) < 1.25 || fabs(RLSetPoint + RLOffset - rearLeftPos->GetDistance()) > 3.75)
		{
		...
		if(fabs(RRSetPoint + RROffset - rearRightPos->GetDistance()) < 1.25 || fabs(RRSetPoint + RROffset - rearRightPos->GetDistance()) > 3.75)
		{
		...
		if(fabs(RRSetPoint + FLOffset - frontLeftPos->GetDistance()) < 1.25 || fabs(RRSetPoint + FLOffset - frontLeftPos->GetDistance()) > 3.75)
		{
		...
		if(fabs(RLSetPoint + FROffset - frontRightPos->GetDistance()) < 1.25 || fabs(RLSetPoint + FROffset - frontRightPos->GetDistance()) > 3.75)
		{
		...
		if(fabs(FRSetPoint + RLOffset - rearLeftPos->GetDistance()) < 1.25 || fabs(FRSetPoint + RLOffset - rearLeftPos->GetDistance()) > 3.75)
		{
		...
		if(fabs(FLSetPoint + RROffset - rearRightPos->GetDistance()) < 1.25 || fabs(FLSetPoint + RROffset - rearRightPos->GetDistance()) > 3.75)
		{
