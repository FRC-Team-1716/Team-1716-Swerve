...
void RobotMap::init() {
	...
	driveTrainFrontRightPos = new Encoder(1,2);
	...
	driveTrainFrontLeftPos = new Encoder(3,4);
	...
	driveTrainRearRightPos = new Encoder(5,6);
	...
	driveTrainRearLeftPos = new Encoder(7,8);
